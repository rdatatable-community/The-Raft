...
* Contribute to [beginner task](https://github.com/Rdatatable/data.table/issues?q=is%3Aissue+is%3Aopen+beginner-task+label%3Abeginner-task) updates or [https://github.com/Rdatatable/data.table/issues?q=is%3Aissue+is%3Aopen+label%3Adocumentation+] needs for the package.

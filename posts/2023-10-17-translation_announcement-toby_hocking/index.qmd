...
-   for each person in your project, what level of fluency in English and other languages? for each person in your project, what local dialects (countries/regions) does the person know? (For Spanish, Mexico vs Spain vs Chile, etc)

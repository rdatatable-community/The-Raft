...
- Authors of packages dependent on data.table said they would be concerned if it was no longer maintained. Most of them said they don't have the resources to maintain a fork and can't depend on something that's not developed as much. They would be happy to sponsor and help sustain the project.
...
- A fair proportion is willing to contribute to a central fund. As for how and to whom will these funds be dispersed, or what would be a good way to distribute them proportionately, remains a question.

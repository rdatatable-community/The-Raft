...
- Financial gain or incentives from working on the project.
...
As gathered from the interviewees, there are various reasons that prevent them from contributing to `data.table`. These include:

...
<!-- TODO: `r subset(checks, grepl('API', Output))[1,]` -->
...
Operating on the S4 bit of R objects: `SET_S4_OBJECT`, `UNSET_S4_OBJECT`
------------------------------------------------------------------------

[#6183][remove_set_s4_object]
...
[remove_isframe]: https://github.com/Rdatatable/data.table/pull/6235

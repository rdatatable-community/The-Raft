...
data.table][datatable_logo]). `data.table` version 1.8.8 (March 2013)
[saw][news188] the addition of the `fread` function that [over-allocated
and later truncated the individual columns][datatable_stretch_column]

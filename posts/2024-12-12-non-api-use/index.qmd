...
<!-- TODO: Since there does't seem to be any intent to allow using R API
to place arbitrary integer values inside unused `SEXP` fields,
`data.table` will have to mark the `CHARSXP` values externally. -->

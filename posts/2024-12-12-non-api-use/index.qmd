...
referencing the same columns (performing a "shallow duplicate"). By
contrast, the [over-allocated vectors][datatable_overallocation] can be
...
shallow duplicates at the cost of making `data.table` shared,

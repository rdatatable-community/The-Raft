...
"rules as written" that the maintainers of CRAN packages must follow.
Even back in R-3.3.0, the oldest version currently supported by
`data.table`, the [chapter 6, "The R API"][WRE33API] classified R's
entry points into four categories:
